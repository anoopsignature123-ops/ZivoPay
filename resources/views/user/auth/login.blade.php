...
@section('title', 'DEX TRADE - Member Portal Login')
    ...
    <div class="space-y-6">
        ...
        <div class="ng-pkg-card p-8 border-2 border-amber-400 ng-auth-card-shadow space-y-6 relative backdrop-blur-xl">
            ...
            <form action="{{ route('user.login') }}" method="POST" class="space-y-4">
                ...
                <!-- User ID / Email Field -->
                <div>
                    <label class="block text-xs font-bold text-amber-400 uppercase mb-1.5">Referral Code / Registered Email</label>
                    <div class="relative">
                        ...
                        <input type="text" name="email" value="{{ old('email') }}" required placeholder="Enter referral code or email..." class="w-full pl-11 pr-4 py-3 rounded-xl bg-bg border border-amber-500/40 text-white font-semibold text-sm focus:outline-none focus:border-amber-400">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="password" id="userPassword" name="password" required placeholder="Enter your password..." class="w-full pl-11 pr-12 py-3 rounded-xl bg-bg border border-amber-500/40 text-white font-semibold text-sm focus:outline-none focus:border-amber-400">

                        <button type="button" onclick="toggleUserPassword()" class="absolute right-3 top-1/2 -translate-y-1/2 p-2 text-amber-400 hover:text-amber-300 transition focus:outline-none" aria-label="Toggle Password Visibility">
                            ...
                            <svg id="userEyeClosed" xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 hidden text-amber-300" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                ...
                <div class="flex items-center justify-between text-xs pt-1">
                    ...
                    <a href="javascript:void(0)" onclick="alert('Password reset link sent to registered email.');" class="text-amber-400 font-bold hover:underline">Forgot password?</a>
                </div>

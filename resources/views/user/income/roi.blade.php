...
@section('title', 'Daily ROI Income Report - ZIVO PAY')
...
<div class="space-y-6 font-sans">
    ...
    <div class="p-6 sm:p-8 rounded-3xl bg-[#042718] border-2 border-emerald-500/60 shadow-2xl flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        ...
        <div class="px-5 py-3 rounded-2xl bg-[#02180f] border border-emerald-500/40 text-right">
            <span class="text-[10px] text-emerald-400 font-extrabold uppercase tracking-wider block">Total Daily ROI Accumulated</span>
    ...
    <div class="bg-[#042718] p-4 rounded-2xl border border-emerald-500/30">
        <form action="{{ route('user.income.roi') }}" method="GET" class="flex flex-wrap items-center gap-3">
            <div>
            ...
            <div class="pt-5 flex items-center gap-2">
                ...
                <a href="{{ route('user.income.roi') }}" class="px-3 py-2 bg-[#01140c] border border-emerald-500/30 text-neutral-400 text-xs rounded-xl hover:text-white transition">
                    Reset
                </a>
            </div>
        </form>
            ...
            <table class="w-full text-left text-xs">
                <thead class="bg-[#02180f] text-emerald-400 font-extrabold uppercase tracking-wider border-b border-emerald-500/30">
                    <tr>
                        ...
                        <th class="px-5 py-4">Wallet Type</th>
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="px-5 py-8 text-center text-neutral-400 font-bold">
                                No daily ROI payout records found. Activate an investment package to start earning.
                            </td>
                        </tr>
                    @endforelse
                </tbody>

...
<div class="space-y-6 font-sans">
    ...
    <div class="p-6 sm:p-8 rounded-3xl bg-[#042718] border-2 border-emerald-500/60 shadow-2xl flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
            ...
            <h1 class="text-2xl sm:text-3xl font-black text-white uppercase tracking-tight mt-1">ROI ON LEVEL INCOME</h1>
    ...
    <div class="bg-[#042718] p-4 rounded-2xl border border-emerald-500/30">
        <form action="{{ route('user.income.level-roi') }}" method="GET" class="flex flex-wrap items-center gap-3">
            <div>
            ...
            <div class="pt-5 flex items-center gap-2">
                ...
                <a href="{{ route('user.income.level-roi') }}" class="px-3 py-2 bg-[#01140c] border border-emerald-500/30 text-neutral-400 text-xs rounded-xl hover:text-white transition">
                    Reset
                </a>
            </div>
        </form>
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="px-5 py-8 text-center text-neutral-400 font-bold">
                                No ROI-on-ROI matching level income recorded yet.
                            </td>
                        </tr>
                    @endforelse
                </tbody>

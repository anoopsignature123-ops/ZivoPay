                ...
                <tbody class="divide-y divide-amber-500/20 text-neutral-200">
                    ...
                    <tr class="hover:bg-amber-500/10 transition">
                        ...
                        <td class="p-4 text-center">
                            <a href="{{ route('user.network.tree', ['code' => $direct->referral_code]) }}" class="px-3 py-1.5 rounded-lg bg-amber-500/20 text-amber-300 hover:bg-amber-500/40 transition text-xs font-bold inline-flex items-center gap-1">
                    ...
                    <tr>
                        <td colspan="6" class="p-8 text-center text-neutral-400 text-sm font-semibold">
                            No direct referrals found yet. Share your referral links to build your team!
                        </td>
                    </tr>
                    @endforelse
                </tbody>

...
function checkValidation() {
    ...
    let userWallet = parseFloat("{{ $user->deposit_wallet }}") || 0;
    let val = parseFloat(input.value);

    if (!input.value || isNaN(val) || val <= 0) {
        submitBtn.disabled = true;
        submitBtn.className = "w-full py-3.5 rounded-xl bg-neutral-800 border border-neutral-700 text-neutral-500 font-black uppercase text-xs cursor-not-allowed transition flex items-center justify-center gap-2";
        ...
        submitBtn.disabled = true;
        submitBtn.className = "w-full py-3.5 rounded-xl bg-rose-950/60 border border-rose-500/50 text-rose-400 font-black uppercase text-xs cursor-not-allowed transition flex items-center justify-center gap-2";
        ...
        submitBtn.className = "w-full py-3.5 rounded-xl bg-gradient-to-r from-emerald-500 via-teal-400 to-emerald-500 text-black font-black uppercase tracking-wider text-xs hover:shadow-[0_0_25px_rgba(16,185,129,0.8)] transition cursor-pointer flex items-center justify-center gap-2 shadow-lg";

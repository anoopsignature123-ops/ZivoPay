...
<div class="w-full space-y-6">
    ...
    <div class="ng-banner-title p-6 sm:p-8 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
        <div>
            ...
            <h1 class="text-2xl sm:text-3xl font-black text-white font-heading">BINARY TEAM TREE VIEW</h1>
        ...
        <div class="flex items-center gap-3 w-full lg:w-auto">
            <form action="{{ route('admin.network.tree') }}" method="GET" class="flex items-center gap-2 w-full lg:w-auto">
                ...
                <button type="submit" class="px-4 py-2.5 rounded-xl bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-400 hover:to-teal-500 text-white font-black text-xs uppercase tracking-wider transition shrink-0">
                    Find Tree Node
                </button>
            </form>
        </div>

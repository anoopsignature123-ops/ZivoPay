    ...
    <div class="ng-banner-title p-6 sm:p-8 flex items-center justify-between gap-4">
        <div>
            <div class="flex items-center gap-2 mb-1">
                ...
                <span class="text-xs text-emerald-400 font-extrabold tracking-[3px] uppercase">USER MANAGEMENT</span>
            </div>
            <h1 class="text-2xl sm:text-3xl font-black text-white font-heading">REGISTER NEW MEMBER</h1>

...
@section('content')
    <div class="space-y-6">
        ...
        <!-- Login Form Card -->
        <div class="ng-pkg-card p-8 border-2 border-emerald-500/60 ng-auth-card-shadow space-y-6 relative bg-[#042718] rounded-3xl">
            <div class="text-center space-y-1">
                <span
                    class="px-3 py-1 rounded-full bg-emerald-500/20 text-emerald-400 text-[10px] font-black uppercase tracking-widest border border-emerald-500/40">
                    RESTRICTED ACCESS
                </span>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <button type="button" onclick="togglePassword()"
                            class="absolute right-3 top-1/2 -translate-y-1/2 w-5 h-5 flex items-center justify-center p-0 m-0 border-0 bg-transparent text-emerald-400 hover:text-emerald-300 transition focus:outline-none cursor-pointer z-10"
                            style="position: absolute !important; right: 14px !important; top: 50% !important; transform: translateY(-44%) !important;"
                            ...
                            <svg id="eyeIconClosed" xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 hidden text-emerald-300" viewBox="0 0 24 24"

    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-panel p-6 shadow-2xl rounded-2xl border border-amber-500/30">
        <div>
            <div class="flex items-center gap-2 text-xs font-semibold text-rose-400 uppercase tracking-widest mb-1">
                ...
                <span>6. Dex Trade Income Stream</span>
            </div>
        ...
        <div class="px-5 py-3 rounded-2xl bg-amber-500/10 border border-amber-500/30 shrink-0 text-right">
            <span class="text-[10px] font-bold text-amber-400 uppercase block">Total Upline Matching Distributed</span>
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="divide-y divide-amber-500/10 text-xs">
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="py-8 text-center text-neutral-400 italic">No Upline Matching income transactions found.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>

...
<div class="space-y-6 font-sans">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div class="bg-panel p-5 rounded-2xl border border-amber-500/30 shadow-xl flex items-center gap-4">
            ...
            <div>
                <p class="text-[11px] font-bold text-amber-400/80 uppercase">Total Referral ROI Paid</p>
    ...
    <div class="p-3.5 rounded-2xl bg-bg/80 border border-amber-500/40 shadow-lg">
        <form action="{{ route('admin.reports.referral-roi') }}" method="GET" class="flex flex-nowrap items-end gap-3 w-full overflow-x-auto text-xs font-sans pb-1">
            ...
            <div class="flex items-center gap-2 shrink-0">
                ...
                <a href="{{ route('admin.reports.referral-roi') }}" class="py-2.5 px-4 rounded-xl bg-black/60 border border-white/60 text-white hover:bg-white/10 font-bold text-xs transition flex items-center justify-center shrink-0">
                    Reset
                </a>
            </div>
        </form>
